        ...
        <form-container name="client">
          <form-row>
            <form-field catch-errors="currenty_id" :label="$t('labels.currency')">
              <form-dropdown-input v-model="form.currency_id" :watch="passive.currencies" name="currency_id" scrollable searchable>
          ...
          <form-row>
            <form-field catch-errors="language_id" :label="$t('labels.language')">
              <form-dropdown-input v-model="form.language_id" :watch="passive.languages" name="language_id" scrollable searchable>
            ...
            <form-field catch-errors="payment_terms" :label="$t('labels.payment_terms')">
              <form-dropdown-input v-model="form.payment_terms" :watch="passive.paymentTerms" name="payment_terms" scrollable searchable>
          ...
          <form-row>
            <form-field catch-errors="company_size_id" :label="$t('labels.company_size')">
              <form-dropdown-input v-model="form.company_size_id" :watch="passive.company_sizes" name="company_size_id" scrollable searchable>
            ...
            <form-field :label="$t('labels.industry')">
              <form-dropdown-input catch-errors="industry_id" :watch="passive.industries" v-model="form.industry_id" name="industry_id" scrollable searchable>
