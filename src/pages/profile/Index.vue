...
import AllActivityTab from '@/pages/overview/tabs/activity/all'
import PaymentsActivityTab from '@/pages/overview/tabs/activity/payments'
import ExpensesActivityTab from '@/pages/overview/tabs/activity/expenses'
import InvoicesActivityTab from '@/pages/overview/tabs/activity/invoices'
import CreditsActivityTab from '@/pages/overview/tabs/activity/credits'
import QuotesActivityTab from '@/pages/overview/tabs/activity/quotes'
import ClientsActivityTab from '@/pages/overview/tabs/activity/clients'
import ProductsActivityTab from '@/pages/overview/tabs/activity/products'
import VendorsActivityTab from '@/pages/overview/tabs/activity/vendors'
import EmployeesActivityTab from '@/pages/overview/tabs/activity/employees'
import ProjectsActivityTab from '@/pages/overview/tabs/activity/projects'
import TasksActivityTab from '@/pages/overview/tabs/activity/tasks'

import UpcomingPaymentsTab from '@/pages/overview/tabs/UpcomingPaymentsTab.vue'
import OverdueInvoicesTab from '@/pages/overview/tabs/OverdueInvoicesTab.vue'
import ProjectsTab from '@/pages/overview/tabs/ProjectsTab.vue'
import TasksTab from '@/pages/overview/tabs/TasksTab.vue'
